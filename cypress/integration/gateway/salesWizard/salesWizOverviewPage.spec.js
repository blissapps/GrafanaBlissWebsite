...
describe('Sales Wizard Overview Page Tests', () => {
  context('General Page Validations', () => {
    ...
    it('C30639291 - Validate Shares to Sell Components', () => {
      const elements = ['Shares to sell', 'Available', 'Available with restrictions', 'Unavailable', 'In progress']
      equityGateway.SalesWizOverviewPage.pageSharesValidation(elements, '25', '25', '25', '25')
    })

    it('C30639291 - Validate Shares to Sell Components', () => {
      const elements = ['Process overview', 'Submit your sale order', 'Sale order will be processed', 'Your holdings are reflected on Gateway', 'Selling shares explanation']
