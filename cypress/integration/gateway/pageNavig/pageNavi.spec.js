...
describe('Page Navigation Tests', () => {
  ...
  context('Dashboard Page Navigations', () => {
    ...
    it('***** - User is redirected to dashboard when it clicks on sidebar Dashboard Button', () => {
      equityGateway.MainPageSideMenu.clickSideMenuButton('Dashboard')
      equityGateway.PageNavi.pageNaviUrlValidation('/dashboard')
    })

    it('***** - User is redirected to Helpdesk when it clicks on sidebar Support-Help Button', () => {
    ...
    it('***** - Validates Dashboard Page Footer', () => {
      equityGateway.FooterBar.checkPage('Help', '/help')
      equityGateway.FooterBar.checkPage('Privacy Policy', '/privacy-policy')
      equityGateway.FooterBar.checkPage('Terms and Conditions', '/terms-and-conditions')
    })

    it('***** - Validates Dashboard Top Bar Personal Information Navigation', () => {
    ...
    it('***** - Validates Dashboard Top Bar Bank Account Navigation', () => {
    ...
    it('***** - Validates Dashboard Top Bar Tax Documents Navigation', () => {
    ...
    it('***** - Validates Dashboard Top Bar Logout Navigation', () => {
      equityGateway.TopBar.accMenuClick(null, 'Logout')
      equityGateway.PageNavi.pageNaviUrlValidation('/welcome')
    })

    it('***** - Validates Dashboard View All Activity Navigation', () => {
  ...
  context('Validate Activity Page Navigation', () => {
     ...
     * EGVFOUR-266
     */
    it('****** - Navigates to Dashboard from Activity Page', () => {
