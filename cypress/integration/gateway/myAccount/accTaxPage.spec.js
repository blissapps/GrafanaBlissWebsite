...
describe('MyAcc TAX Sector Tests', () => {
  ...
  context('Filter Validations', () => {
    it('Filter by Year', () => {
      const elementsExist = ['Report - 2020']
      const elementsNotExist = ['Report - 2021', 'Report - 2022']
    ...
    it('Filter by Type', () => {
      const elementsExist = ['Report - 2020']
      const elementsNotExist = ['Report - 2021', 'Report - 2022', 'No results available']
    ...
    it('Complex Filter Year Type Not Match', () => {
      const elementsExist = ['No results available']
      const elementsNotExist = ['Report - 2021', 'Report - 2022']
