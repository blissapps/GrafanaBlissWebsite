...
describe('MyAcc Profile Sector Tests', () => {
  ...
  context('Personal Information Validations', () => {
    ...
    it('C30092720 - Profile and Demographic Content Titles', () => {
      const pageSections = ['Place of birth', 'Date of birth', 'Citizenship', 'Nationality']
      equityGateway.AccProfilePage.profileContent(pageSections)
    })

    it('C30092720 - Profile and Demographic Content Info', () => {
      equityGateway.AccProfilePage.profileContent(null, 'Rochford', '2003/01/21', 'Portuguese, Italian', 'Portuguese')
    })
  })
  ...
  context('Tax identification Validations', () => {
    ...
    it('C30092721 - Tax Content Titles', () => {
      const taxSections = ['Country of tax residence', 'Primary tax ID type', 'Primary tax ID number']
      equityGateway.AccProfilePage.taxContent(taxSections)
    })

    it('C30092721 - Tax Content Info', () => {
      equityGateway.AccProfilePage.taxContent(null, 'United Kingdom of Great Britain', 'National Insurance Number (NINO)', 'VH997799A')
    })
  })
  ...
  context('Identifiers Validations', () => {
    ...
    it('C30092722 - Tax Content Titles', () => {
      const idSections = ['Stockholder ID', 'Employee ID', 'External Participant ID', 'Tax ID', 'Social Security Number']
      equityGateway.AccProfilePage.identifiersContent(idSections)
    })

    it('C30092722 - Tax Content Info', () => {
      equityGateway.AccProfilePage.identifiersContent(null, 'SID24567', 'GS_028', '29283820', '2873847', '12391829')
    })
  })
  ...
  context('Contact Details Validations', () => {
    ...
    it('C30092723 - Contact Details Content Titles', () => {
      const contactSections = ['Email', 'Phone Number', 'personalEmailAddress', 'suppliedEmailAddress', 'Preferred for email communications']
  ...
  context('Address Details Validations', () => {
    ...
    it('C30092723 - Address Details Content', () => {
      const addressInfo = ['Residential', '2 Tennessee Avenue', 'Block E Apartment 949', '16501 Erie', 'United Kingdom of Great Britain']
