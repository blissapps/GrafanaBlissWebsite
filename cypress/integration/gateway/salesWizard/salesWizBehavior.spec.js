...
describe('Sales Wizard Behavior Tests', () => {
  ...
  context('Validate Complex Behavior and Calculus Scenarios', () => {
     ...
     */
    //TODO THIS TEST MAY BE COVERED BY OTHER SCENARIOS ALREADY IMPLEMENTED
     ...
     */
    it('C1109831 - SaleWizard DistributionCurrency Preferred SaleDistributionCurrency', () => {
      /*
     ...
     */
    it('C1109833 - SaleWizard DistributionCurrency No PreferredSaleDistributionCurrency', () => {
      /*
     ...
     */
    it('C4267056 - Check SaleWizardFundDistribution SelectionBehavior ABAOnly LowestCostAvailable', () => {
      /*
     ...
     */
    it('C4267057 - Check SaleWizardFundDistribution SelectionBehavior ABAOnly HighValue', () => {
      /*
      equityGateway.loginPage.initaliseGateway('cashgen053')
      equityGateway.loginPage.login('cashgen053_01', Cypress.env('EQUITY_GATEWAY_DEFAULT_PASSWORD_AUTH'))
      equityGateway.applicationHeader.navigateSalesWizard()
     ...
     */
    it('C4267058 - Check SaleWizardFundDistribution SelectionBehavior ABAOnly LowValue', () => {
      /*
      equityGateway.loginPage.initaliseGateway('cashgen053')
      equityGateway.loginPage.login('cashgen053_01', Cypress.env('EQUITY_GATEWAY_DEFAULT_PASSWORD_AUTH'))
      equityGateway.applicationHeader.navigateSalesWizard()
     ...
     */
    it('C4267059 - Check SaleWizardFundDistribution SelectionBehavior SWIFTOnly LowestCostAvailable', () => {
      /*
      equityGateway.loginPage.initaliseGateway('cashgen053')
     ...
     */
    it('C4267060 - Check SaleWizardFundDistribution SelectionBehavior SWIFTOnly HighValue', () => {
      /*
      equityGateway.loginPage.initaliseGateway('cashgen053')
      equityGateway.loginPage.login('cashgen053_02', Cypress.env('EQUITY_GATEWAY_DEFAULT_PASSWORD_AUTH'))
      equityGateway.applicationHeader.navigateSalesWizard()
     ...
     */
    it('C4267061 - Check SaleWizardFundDistribution SelectionBehavior SWIFTOnly LowValue', () => {
      /*
      equityGateway.loginPage.initaliseGateway('cashgen053')
      equityGateway.loginPage.login('cashgen053_02', Cypress.env('EQUITY_GATEWAY_DEFAULT_PASSWORD_AUTH'))
      equityGateway.applicationHeader.navigateSalesWizard()
     ...
     */
    it('C4267062 - Check SaleWizardFundDistribution SelectionBehavior ABAANDSWIFT LowestCostAvailable', () => {
      /*
      equityGateway.loginPage.initaliseGateway('cashgen053')
     ...
     */
    it('C4267063 - Check SaleWizardFundDistribution SelectionBehavior ABA AND SWIFT HighValue ABA', () => {
      /*
      equityGateway.loginPage.initaliseGateway('cashgen053')
      equityGateway.loginPage.login('cashgen053_03', Cypress.env('EQUITY_GATEWAY_DEFAULT_PASSWORD_AUTH'))
      equityGateway.applicationHeader.navigateSalesWizard()
     ...
     */
    it('C4267064 - Check SaleWizardFundDistribution SelectionBehavior ABA AND SWIFT HighValue SWIFT', () => {
      /*
      equityGateway.loginPage.initaliseGateway('cashgen053')
      equityGateway.loginPage.login('cashgen053_03', Cypress.env('EQUITY_GATEWAY_DEFAULT_PASSWORD_AUTH'))
      equityGateway.applicationHeader.navigateSalesWizard()
     ...
     */
    it('C4267065 - Check SaleWizardFundDistribution SelectionBehavior ABA AND SWIFT LowValue ABA', () => {
      /*
      equityGateway.loginPage.initaliseGateway('cashgen053')
      equityGateway.loginPage.login('cashgen053_03', Cypress.env('EQUITY_GATEWAY_DEFAULT_PASSWORD_AUTH'))
      equityGateway.applicationHeader.navigateSalesWizard()
     ...
     */
    it('C4267066 - Check SaleWizardFundDistribution SelectionBehavior ABA AND SWIFT HighValue ABA', () => {
      /*
      equityGateway.loginPage.initaliseGateway('cashgen053')
      equityGateway.loginPage.login('cashgen053_03', Cypress.env('EQUITY_GATEWAY_DEFAULT_PASSWORD_AUTH'))
      equityGateway.applicationHeader.navigateSalesWizard()
     ...
     */
    it('C14979617 - Check Sale Proceeds and Capital Gain are calculated correctly when the client only has Limit Order type', { tags: 'V3' }, () => {
      /*
     ...
     */
    it('C14979618 - Check Sale Proceeds and Capital Gain are calculated correctly when the client only has GTD Order type', { tags: 'V3' }, () => {
      /*
     ...
     */
    it('C15255993 - Verify Bank Details Collection No Bank Details on Participant', { tags: 'V3' }, () => {
      /*
     ...
     */
    it('C15255994 - Verify Bank Details Collection No Bank Details Present on Participant', { tags: 'V3' }, () => {
      /*
      equityGateway.loginPage.initaliseGateway('bankDetailscollectionno')
     ...
     */
    it('C15255999 - Verify Bank Details Collection Yes No Bank Details on Participant Sale', { tags: 'V3' }, () => {
      /*
     ...
     */
    it('C15256000 - Verify Bank Details Collection Yes Bank Details Present on Participant Sale', { tags: 'V3' }, () => {
      /*
      equityGateway.loginPage.initaliseGateway('bankDetailscollectionyes')
     ...
     */
    it('C17344553 - Process A Sale From Wizard Which Has Issuances From Both Issuance Types', { tags: 'V3' }, () => {
      /*
